...
if __name__ == "__main__":
    # Example usage
    print("Home Loans Drift Detection Module")
    print("This module detects drift in Home Loans neural network models")
    print("Use detect_home_loans_drift() for simple drift detection")
    print("Or use HomeLoansDriftDetector class for advanced analysis") 
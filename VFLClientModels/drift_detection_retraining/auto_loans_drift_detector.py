...
if __name__ == "__main__":
    # Example usage
    print("Auto Loans Drift Detection Module")
    print("This module detects drift in Auto Loans neural network models")
    print("Use detect_auto_loans_drift() for simple drift detection")
    print("Or use AutoLoansDriftDetector class for advanced analysis") 